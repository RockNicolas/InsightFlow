...
def create_observation_report(excel_path, sheet_name, output_folder):
    ...
    try:
        ...
        title_style = ParagraphStyle("Title", parent=styles["Title"], fontSize=18, alignment=TA_RIGHT, rightIndent=230)
        titulo = Paragraph("CONTROLE DE OBSERVAÇÕES MENSAL", title_style)
